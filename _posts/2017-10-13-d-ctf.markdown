...
---
Ao extrair o arquivo zipado vem dois arquivos, um `lock.iso` e um `ransomware.py` .
...
Fazendo um simples decrypter ou simplismente rodando um binwalk ou um foremost teremos a flag!
``` python
#!/usr/bin/python
